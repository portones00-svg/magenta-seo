...
<head>
  ...
  <title>Iniciar sesión — _AgenteSEO</title>
  <style>
...
<body>
  <div class="box">
    <div style="display:flex;justify-content:center;margin-bottom:8px"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 200 32" style="height:26px;width:auto;display:block" role="img" aria-label="_AgenteSEO"><text x="0" y="24" font-family="'Poppins',Arial,sans-serif" font-weight="700" font-size="26" letter-spacing="-0.3"><tspan fill="#e8791a">_</tspan><tspan fill="#1a1a1a">Agente</tspan><tspan fill="#e8791a">SEO</tspan></text></svg></div>
